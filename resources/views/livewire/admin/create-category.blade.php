    ...
    <x-jet-dialog-modal wire:model="editForm.open">
        ...
        <x-slot name="content">
            ...
            <div class="space-y-3">
                ...
                <div>
                    @if ($editImage)
                        <img class="w-full object-cover object-center" src="{{$editImage->temporaryUrl()}}" alt="">
                    @else
                        <img class="w-full object-cover object-center" src="{{Storage::url($editForm['image'])}}" alt="">
                    @endif
                </div>
