...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>ADL-Compras</title>
        <link rel="shortcut icon" href="{{asset('img/icon.png')}}" class="h-12" style="width: 50px">
        <!-- Fonts -->
        ...
        <script src="https://kit.fontawesome.com/40e6d27289.js" crossorigin="anonymous"></script>
