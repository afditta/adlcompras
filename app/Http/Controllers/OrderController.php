...
class OrderController extends Controller
{
    ...
    public function pay(Order $order, Request $request){
        ...
        $response = Http::get("https://api.mercadopago.com/v1/payments/$payment_id" . "?access_token=APP_USR-3880627694573952-112212-517dd59afc57656824d19ab56eb700bf-1245426748");
    ...
    public function recibed(Order $order, Request $request)
    {
        $order->status = 2;
        $order->save();
        return redirect()->route('orders.show', $order);
